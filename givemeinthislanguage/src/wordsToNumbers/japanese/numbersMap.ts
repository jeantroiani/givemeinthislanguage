  ...
  export const japanese: LanguageSet = {
    ...
    'juuichi': 11, 'juuni': 12, 'juusan': 13, 'juushi': 14,
    'juugo': 15, 'juuroku': 16, 'juushichi': 17, 'juuhachi': 18,
    'juukyuu': 19, 'nijuu': 20, 'sanjuu': 30, 'yonjuu': 40,
    'gojuu': 50
  };

  export const japaneseKanjis: LanguageSet = {
